...
function ArcJoin.getTargetPoint(
	startFrame: CFrame,
	targetFrame: CFrame,
	size: vector,
	targetSize: vector,
...
function ArcJoin.getTangents(
	...
	local _, _, _, start, finish =
		getArcGuide(startFrame, endPoint, endNormal, localNormal, surfaceOffset, targetRotation)
	return start, finish
end
